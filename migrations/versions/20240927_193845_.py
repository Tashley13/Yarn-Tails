...
Revision ID: 7dbcf1c59165
Revises: 
Create Date: 2024-09-27 19:38:45.036186
...
def upgrade():
    ...
    sa.Column('test_due', sa.Date(), nullable=False),
    sa.Column('test_posted', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    ...
    op.create_table('checkout_pattern',
    ...
    sa.PrimaryKeyConstraint('checkout_id', 'pattern_id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('checkout_pattern')
